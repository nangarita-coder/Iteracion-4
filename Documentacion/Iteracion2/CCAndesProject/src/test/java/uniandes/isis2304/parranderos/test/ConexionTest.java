    ...
    public void normalAccessTest ()
  	{
  	  	try
		{
			...
			ccAndes = new CCAndes (openConfig (CONFIG_TABLAS_A));
			log.info ("Conexión realizada correstamente");
			log.info ("Cerrando la conexión");
			
			ccAndes.cerrarUnidadPersistencia ();
...
//			System.out.println (msg);
    ...
    public void baseDatosInaccesible ()
    {
		try
		{
			...
			ccAndes = new CCAndes (openConfig (CONFIG_TABLAS_ERR_DS));
...
//			e.printStackTrace();
    ...
    public void usuarioInvalidoTest ()
    {
		try
		{
			...
			ccAndes = new CCAndes (openConfig (CONFIG_TABLAS_ERR_USER));
...
//			ccAndes = new CCAndes (openConfig (CONFIG_TABLAS_B));
//		}
//		catch (Exception e)
//		{
////			e.printStackTrace();
